    ...
    <div class="col-lg-12">
    	<div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form action="<?=site_url('user_members/edit_process/id/'.$this->uri->segment(4))?>" class="form-horizontal form-seperated" id="form-edit" role="form" method="post">
                    <div class="form-body">
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="InputText">Role <span class="require">*</span></label>
                            <div class="col-md-6">
                            <?php echo form_dropdown('roleid',$role,'','id="roleid" class="select2-size form-control" value=4 ');?>
                            </div>
                        </div>
                        <div class="form-group">
							...
							<?php echo form_dropdown('member_id',$member,$detail['member_id'],'id="member_id" class="select2-size form-control" ');?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="InputText">Username</label>
                            <div class="col-md-6">
                                <input id="username" name="username" class="form-control " type="text" placeholder="Username" maxlength="100" value="<?=$detail['username']?>" readonly="readonly">
                            </div>
...
<div class="row">
    <div class="col-lg-1">
        <div class="panel">
            <a href="<?=site_url('user_members')?>" class="btn btn-success"><i class="fa fa-arrow-left"></i> Kembali</a>
        </div>
    </div>
</div>

    ...
    <div class="col-lg-12">
    	<div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form action="<?=site_url('user_members/add_process')?>" class="form-horizontal form-seperated" id="form-tambah" role="form" method="post">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="InputText">Anggota <span class="require">*</span></label>
                            <div class="col-md-6">
                            <?php echo form_dropdown('member_id',$member,'','id="member_id" class="select2-size form-control" ');?>
                            </div>
                        </div>
                        <div class="form-group">
